...
class Title {
  constructor({ gl, plane, renderer, text, textColor = "#545050", font = "400px sans-serif" }) {
    autoBind(this)
    this.gl = gl
    this.plane = plane
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
  { image: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/html5/html5-original.svg', text: 'HTML' },
  { image: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/css3/css3-original.svg', text: 'CSS' },
  { image: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/javascript/javascript-original.svg', text: 'JavaScript' },
  { image: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/java/java-original.svg', text: 'Java' },
  ...
  {
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ26hPzqOVC9afCCWVQRU1RtjIsz_IB633GQQ&s',
    text: 'Node.js'
  },
  {
